...
function metro_google_fonts() {
	wp_enqueue_style( 'google-font-open', '//fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,600,700,800,300', array(), CHILD_THEME_VERSION );
	wp_enqueue_style( 'google-font-oswald', '//fonts.googleapis.com/css?family=Oswald:400,300,700', array(), CHILD_THEME_VERSION );
}
...
genesis_register_sidebar( array(
	'id'          => 'gajg-top',
	'name'        => __( 'Get a Job Girl - Top', 'metro' ),
	'description' => __( 'This is the top section of the homepage.', 'metro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'gajg-middle-left',
	'name'        => __( 'Get a Job Girl - Middle Left', 'metro' ),
	'description' => __( 'This is the middle left section of the homepage.', 'metro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'gajg-middle-right',
	'name'        => __( 'Get a Job Girl - Middle Right', 'metro' ),
	'description' => __( 'This is the middle right section of the homepage.', 'metro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'gajg-bottom',
	'name'        => __( 'Get a Job Girl - Bottom', 'metro' ),
	'description' => __( 'This is the bottom section of the homepage.', 'metro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'after-entry',
